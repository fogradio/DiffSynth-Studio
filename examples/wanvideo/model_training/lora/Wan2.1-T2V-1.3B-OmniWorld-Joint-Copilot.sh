...
# ---------------- DiT LoRA SFT (mistake-forcing) inputs ----------------
...
OUTPUT_PATH="${WAN21_OMNIWORLD_JOINT_LORA_OUTPUT:-/mnt/workspace/hwzhang/code/mistake_forcing/outputs/wan21_t2v_1_3b_omniworld_joint_copilot_lora}"
...
# LoRA-typical learning rate (1-2 orders higher than full FT).
DIT_LR="${DIT_LR:-1e-4}"
# Default: save DiT LoRA + copilot every 200 global steps. Set SAVE_STEPS="" to fall
...
# Optional: warm-start LoRA from an existing checkpoint.
LORA_CHECKPOINT="${LORA_CHECKPOINT:-}"

# ---------------- Copilot inputs ----------------
# Copilot remains a fully-trained module (no LoRA); only the DiT side is LoRA-fied.
