...
OUTPUT_PATH="${OUTPUT_PATH:-/projects_vol/gp_chuanxia.zheng/hwzhang/code/mistake_forcing/outputs/wan21_t2v_1_3b_wisa_joint_copilot_v2}"
...
DIT_LR="${DIT_LR:-5e-6}"
# Save DiT + copilot every 200 global steps. Set SAVE_STEPS="" for per-epoch.
